...
<html lang="en">
    ...
    <body>
        ...
        <form id="contactForm" enctype="multipart/form-data" name="contact_form" method="POST" action="index.php">
            ...
            <label for="uploadedhttps://prod.liveshare.vsengsaas.visualstudio.com/https://prod.liveshare.vsengsaas.visualstudio.com/join?1F6A17C63EC2C44F7433A5156FE5A86EB4E1File" style="display: inline-block; width: 100px;">Attachment</label>
